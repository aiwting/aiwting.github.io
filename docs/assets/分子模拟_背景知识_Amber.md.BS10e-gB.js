import{_ as s,c as n,ag as p,o as l}from"./chunks/framework.mHuDn-wg.js";const u=JSON.parse('{"title":"认识Amber","description":"","frontmatter":{},"headers":[],"relativePath":"分子模拟/背景知识/Amber.md","filePath":"分子模拟/背景知识/Amber.md","lastUpdated":null}'),e={name:"分子模拟/背景知识/Amber.md"};function i(o,a,t,r,c,d){return l(),n("div",null,a[0]||(a[0]=[p(`<h1 id="认识amber" tabindex="-1">认识Amber <a class="header-anchor" href="#认识amber" aria-label="Permalink to &quot;认识Amber&quot;">​</a></h1><div class="tip custom-block"><p class="custom-block-title">什么是amber?</p><p><strong>Amber</strong>，是一组用于模拟生物分子的分子力学力场；也是一套生物分子模拟程序。</p></div><h2 id="amber-programs" tabindex="-1">Amber programs <a class="header-anchor" href="#amber-programs" aria-label="Permalink to &quot;Amber programs&quot;">​</a></h2><ul><li>Amber全称Assisted Model Building with Energy Refinemegnt， 是由University of California, San Francisco的Kollman教授课题组开发的一套分子力学和分子动力学模拟软件，包括大约60个程序，如 sander. xleap, antechamber、ptraj、mm_pbsa和nmode等。</li><li>Amber尤擅长于生物体系的分子动力学模拟,功能全面。对于材料体系,则可以考虑使用Lammps。</li><li>Amber的优点是计算精度高，自定义新分子和新模型比较方便。缺点是计算效率低，速度慢(相比于GROMACS)</li><li>与CHARMM不同，Amber不是一个all-in-one的分子动力学软件，也不是某一个程序的名字，而是由多个各司其职的程序所构成的工具集，除了高性能动力学引擎外的其他组分统称AmberTools</li><li>Amber软件套件分为两个部分: <ul><li>AmberTools, 一组主要根据GPL许可证免费提供的程序</li><li>Amber，在AmberTools的基础上构建，增加了pmemd模拟程序，并按照更严格的许可证获得许可, <strong>现在Amber24可以免费用于非商业用途</strong></li></ul></li><li>Amber 是一个完整的分子动力学模拟软件套件，提供了模拟引擎、力场参数化工具和分析工具等功能。</li><li>AmberTools 提供了一些额外的工具和实用程序，用于辅助分子模拟的前后处理。如构象生成、参数化、模型构建、能量计算、轨迹分析等</li><li>Amber可以用于生物大分子体系的分子力学计算和分子动力学模拟，也可以采用MM_PBSA和MM_GBSA方法研究受体和配体之间的结合自由能，还可进行量子力学和分子力学结合(QM/MM)计算。</li></ul><h2 id="amber-force-fields" tabindex="-1">Amber Force Fields <a class="header-anchor" href="#amber-force-fields" aria-label="Permalink to &quot;Amber Force Fields&quot;">​</a></h2><ul><li>最初AMBER力场是专门为了计算蛋白质和核酸体系而开发的，计算其力场参数的数据均来自实验值。後来随著AMBER力场的广泛应用，包括Kollman在内的很多课题组对AMBER力场的内容不断进行丰富，逐渐开发出了一个可以用於生物大分子、有机小分子和高分子模拟计算的力场体系。</li><li>AMBER力场的优势在于对生物大分子的计算，其对小分子体系的计算结果常常不能令人满意。AMBER力场的势能函数形势较为简单，所需参数不多，计算量也比较小。主要适用于蛋白质和核酸体系、多糖。</li><li>对于不同的物质，amber有不同的力场，<a href="https://ambermd.org/AmberModels.php" target="_blank" rel="noreferrer">The Amber Force Fields (ambermd.org)</a><ul><li>a protein force field (recommended choice is ff14SB)</li><li>a DNA force field (recommended choice is OL15)</li><li>an RNA force field (recommended choice is OL3)</li><li>a carbohydrate force field (recommended choice is GLYCAM_06j)</li><li>a lipid force field (recommended choice is lipid17)</li><li>a water model with associated atomic ions (more variable); popular choices are spc/e, tip4pew, and OPC. Not needed if you are using an implicit solvent model.</li><li>a general force field, for organic molecules like ligands (recommended choice is gaff2)</li><li>other components (such as modified amino acids or nucleotides, other ions), as needed</li></ul></li></ul><h2 id="amber的文件" tabindex="-1">amber的文件 <a class="header-anchor" href="#amber的文件" aria-label="Permalink to &quot;amber的文件&quot;">​</a></h2><p>amber 的文件格式规范，在amber官网的 File Formats 页面可以找到各种文件的描述：<a href="https://ambermd.org/FileFormats.php" target="_blank" rel="noreferrer">Amber File Formats (ambermd.org)</a></p><h3 id="力场参数文件" tabindex="-1">力场参数文件 <a class="header-anchor" href="#力场参数文件" aria-label="Permalink to &quot;力场参数文件&quot;">​</a></h3><ul><li>在 ambertools 安装目录的/dat/leap目录下存放着力场相关文件，包括： <ul><li>拓扑参数文件格式(.prmtop,/.top/.parm7)</li><li>结构坐标（和速度）文件格式(.inpcrd/.restrt/.rst7)</li><li>轨迹文件格式(.mdcrd/.crd/.nc)</li><li>力场参数加载命令文件(leaprc.xxx.xx)</li><li>力场参数文件（.dat）</li><li>力场参数文件(.lib/.off)</li><li>力场参数文件(.prepi/.in/.prepin)</li><li>力场参数修改文件(frcmod)</li></ul></li><li>为了在 Leap 中添加参数集，需要一个 lib 文件和一个 frcmod 文件，leaprc 文件是调用推荐组合的预制脚本。</li><li>$AMBERHOME/dat/leap/ 目录下有四个文件夹，主要几类文件分别如下： <ul><li>list of leaprc files available - $AMBERHOME/dat/leap/cmd</li><li>list of lib/off files available - $AMBERHOME/dat/leap/lib</li><li>list of frcmod/dat files available - $AMBERHOME/dat/leap/parm</li><li>list of prepi/in/prepin files available - $AMBERHOME/dat/leap/prep</li></ul></li></ul><h4 id="leaprc" tabindex="-1">leaprc.* <a class="header-anchor" href="#leaprc" aria-label="Permalink to &quot;leaprc.*&quot;">​</a></h4><p>/cmd 文件夹下的力场参数加载命令文件 leaprc.GLYCAM_06j-1 从上到下内容依次是：</p><ul><li>元素及其对应的原子类型</li><li>加载原子类型及其杂化信息 .dat 文件</li><li>加载主力场参数及残基参数 .prep .lib</li><li>定义匹配PDB文件中的氨基酸名</li><li>HIS残基的质子化处理（此力场没有）</li><li>加载溶剂及离子</li></ul><div class="language-terminal vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">terminal</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>addAtomTypes {</span></span>
...
<span class="line"><span>  3C          1.9080  0.1094             Spellmeyer</span></span></code></pre></div><h4 id="prep-或-prepin-或-in" tabindex="-1">*.prep 或 *prepin 或 *in <a class="header-anchor" href="#prep-或-prepin-或-in" aria-label="Permalink to &quot;\\*.prep 或 \\*prepin 或 \\*in&quot;">​</a></h4><p>/prep 文件夹下拓扑数据库文件 GLYCAM_06J-1.prep 记录了各种残基信息：</p><div class="language-terminal vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">terminal</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>4ZB  INT 0     ;残基名 内坐标 二进制输出</span></span>
...
<span class="line"><span></span></span>
<span class="line"><span>DONE</span></span></code></pre></div><p>注意：prepi和prepc分别是内坐标和卡迪尔坐标系的prep文件, 是以前程序prep使用的 (现已由leap整合),可由antechamber或prepgen产生, 现常用于非标准残基读入和处理</p><h4 id="lib" tabindex="-1">*.lib <a class="header-anchor" href="#lib" aria-label="Permalink to &quot;\\*.lib&quot;">​</a></h4><ul><li>/lib 文件夹下的 .lib 文件记录了氨基酸残基的符号及每个残基的描述</li><li>例如 GLYCAM_animo_06j_12SB.lib 文件，为了将聚糖与蛋白质连接起来，必须加载含有修饰氨基酸残基（Ser、Thr、Hyp 和 Asn）的lib。要使用 ff14SB 构建糖蛋白，必须加载 <code>GLYCAM_amino_06j_12SB.lib</code> <code>GLYCAM_aminont_06j_12SB.lib</code> 和 <code>GLYCAM_aminoct_06j_12SB.lib</code>，并且还必须加载所需的蛋白质力场。</li></ul><h3 id="模拟相关文件" tabindex="-1">模拟相关文件 <a class="header-anchor" href="#模拟相关文件" aria-label="Permalink to &quot;模拟相关文件&quot;">​</a></h3><ul><li>prmtop文件，又名parm7，top，包含分子，原子名称、种类，电荷，键关系，键参数和非键参数信息</li><li>.prmtop 和 .prmcrd：topology and coordinate files，可以由 LEaP 程序生成。</li><li>.top 和 .crd</li><li>.inpcrd：input initial coordinate file，包含了原子的所有坐标，以及模拟盒子的形状。</li><li>.mdcrd：轨迹文件</li></ul><h2 id="拓展阅读" tabindex="-1">拓展阅读 <a class="header-anchor" href="#拓展阅读" aria-label="Permalink to &quot;拓展阅读&quot;">​</a></h2><ul><li><a href="https://ambermd.org/" target="_blank" rel="noreferrer">Amber官网(ambermd.org)</a></li><li><a href="https://ambermd.org/tutorials/" target="_blank" rel="noreferrer">Amber Tutorials (ambermd.org)</a></li><li><a href="http://tanglab.pku.edu.cn/2022/12/27/R&amp;D/2022/20221227-AmberTutorial0/" target="_blank" rel="noreferrer">轻松上手Amber&amp;AmberTools|Tanglab@PKU</a></li><li><a href="https://jerkwin.github.io/2018/01/17/AMBER%E5%9F%BA%E7%A1%80%E6%95%99%E7%A8%8BB0-AMBER%E5%88%86%E5%AD%90%E5%8A%A8%E5%8A%9B%E5%AD%A6%E6%A8%A1%E6%8B%9F%E5%85%A5%E9%97%A8/#amber%E5%9F%BA%E7%A1%80%E6%95%99%E7%A8%8Bb0" target="_blank" rel="noreferrer">AMBER基础教程|Jerkwin</a></li><li><a href="https://fy-han.github.io/tags/AMBER/" target="_blank" rel="noreferrer">AMBER入门进阶|Hexo</a></li><li><a href="https://zhuanlan.zhihu.com/p/666826404?utm_id=0" target="_blank" rel="noreferrer">WSL2 上的 Amber24 与 Ambertools 24 编译</a></li></ul>`,31)]))}const b=s(e,[["render",i]]);export{u as __pageData,b as default};
