import{_ as s,c as n,ag as p,o as e}from"./chunks/framework.mHuDn-wg.js";const l="/assets/2024-12-23-13-14-44.F3QbiCTZ.png",t="/assets/2024-12-23-12-43-01.TvoNsc0i.png",m=JSON.parse('{"title":"认识GROMACS","description":"","frontmatter":{},"headers":[],"relativePath":"分子模拟/背景知识/GROMACS.md","filePath":"分子模拟/背景知识/GROMACS.md","lastUpdated":null}'),i={name:"分子模拟/背景知识/GROMACS.md"};function r(o,a,c,d,h,u){return e(),n("div",null,a[0]||(a[0]=[p(`<h1 id="认识gromacs" tabindex="-1">认识GROMACS <a class="header-anchor" href="#认识gromacs" aria-label="Permalink to &quot;认识GROMACS&quot;">​</a></h1><div class="tip custom-block"><p class="custom-block-title">What is gromacs?</p><p>GROMACS is a <strong>free and open-source</strong> software suite for high-performance molecular dynamics and output analysis.</p></div><p>GROMACS是一套功能齐全的程序，用于执行分子动力学模拟，即使用牛顿运动方程模拟具有数亿到数百万个粒子的系统的行为。它主要用于<strong>蛋白质、脂质和聚合物的研究</strong>，但也可以应用于各种化学和生物学研究问题。</p><h2 id="gromacs的文件" tabindex="-1">GROMACS的文件 <a class="header-anchor" href="#gromacs的文件" aria-label="Permalink to &quot;GROMACS的文件&quot;">​</a></h2><p>gromacs各种文件的格式可以参考：</p><ul><li>官方文档：<a href="https://manual.gromacs.org/current/index.html" target="_blank" rel="noreferrer">GROMACS documentation</a></li><li>中文：<a href="https://jerkwin.github.io/GMX/GMXman-5/#561-%E6%AE%8B%E5%9F%BA%E6%95%B0%E6%8D%AE%E5%BA%93" target="_blank" rel="noreferrer">GROMACS中文手册|Jerkwin</a>，翻译不全, 版本落后, 不推荐</li></ul><h3 id="力场参数文件" tabindex="-1">力场参数文件 <a class="header-anchor" href="#力场参数文件" aria-label="Permalink to &quot;力场参数文件&quot;">​</a></h3><p>在 gromacs 安装目录的share/gromacs/top目录下存放着力场相关文件：包括各种 .ff 文件夹以及许多以 .dat为扩展名的纯文本帮助文件。</p><h4 id="residuetypes-dat" tabindex="-1">residuetypes.dat <a class="header-anchor" href="#residuetypes-dat" aria-label="Permalink to &quot;residuetypes.dat&quot;">​</a></h4><p>记录了支持的残基种类：残基名 种类</p><div class="language-residuetypes.dat vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">residuetypes.dat</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>GLY	Protein</span></span>
